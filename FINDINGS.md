...
| F35 | ~~High~~ | Data residency | Volume backups were switched on 2026-08-17, and Railway's own DPA says its primary processing is in the United States, with backups "across multiple sites and regions" and none named. A backup is a complete copy of every child's photograph, drawing and voice note, and SAFEGUARDING rule 10 commits StoryJar to UK or EU storage. **Resolved 2026-09-07: Railway confirmed to the owner that volume backups are stored in the same region as the service, EU West (Amsterdam).** Recorded in RETENTION.md and DPIA R6. | **Resolved** 2026-09-07 |
...
## F35 · Backups exist now, and the written evidence points at the United States · High → Resolved 2026-09-07

**Resolved 2026-09-07.** The owner put the direct question below to Railway and
...
(R6). Rule 10 holds for backups as it does for the volume. The section below is
kept as written, because the reasoning about why inference was not enough is
