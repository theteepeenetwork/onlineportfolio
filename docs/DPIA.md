...
**Version:** 1.2 (draft for sign-off) · **Written:** 15 August 2026 · **Updated:** 17 August 2026 (R15, platform operator identity, the operator read screens with their lookup records, and the read-only billing view, which adds no new category of personal data; previously 16 August 2026 for R14 and 15 August 2026 for R6)
