...
3. **The approval queue is sacred.** Every child-generated moment stays `PENDING`
   ...
   **Scope note (2026-09-10) — the classroom board.** This rule governs what
   ...
   that no child's work is seen before approval were inaccurate in this
   respect (FINDINGS F84), and were reworded on 13 September 2026 to name
   the board exception; `security/published-promises.spec.ts` holds them.
